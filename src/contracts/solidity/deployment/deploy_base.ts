...
async function main() {
  ...
  console.log("TelemetryVerifier deployed to Base at:", await telemetryVerifier.getAddress());
  ...
  console.log("FundingVerifier deployed to Base at:", await fundingVerifier.getAddress());
}
